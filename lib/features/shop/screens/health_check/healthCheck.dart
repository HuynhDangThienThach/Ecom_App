                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text("Đánh giá nguy cơ mắc bệnh hen suyễn", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),textAlign: TextAlign.center,),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Kiểm tra", style: TextStyle(color: Colors.grey[900], fontSize: 15),),
                            const Text("Đánh giá nguy cơ mắc bệnh phổi tắc nghẽn mạn tính", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),textAlign: TextAlign.center,),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Kiểm tra", style: TextStyle(color: Colors.grey[900], fontSize: 15),),
                            const Text("Đánh giá nguy cơ lạm dụng thuốc cắt cơn hen", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),textAlign: TextAlign.center,),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Kiểm tra", style: TextStyle(color: Colors.grey[900], fontSize: 15),),
                            const Text("Đánh giá nguy cơ bệnh trào ngược dạ dày và thực quản", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),textAlign: TextAlign.center,),
                          ],
                        ),
                      ),
                    ),
