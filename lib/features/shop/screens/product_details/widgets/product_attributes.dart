...
class TProductAttributes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Column(
        children: [
          //--- Selected Attributed Pricing & Description
          // Hiển thị giá và kho của variation khi được chọn
          ...
          Column(
            ...
            children: product.productAttributes!.map((attribute) => Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // -- Lặp và lấy key từ productAttributes
                TSectionHeading(title: attribute.name ?? '', showActionButton: false,),
                const SizedBox(height: TSizes.spaceBtwItems /2,),
                Obx(
                  () => Wrap(
                    spacing: 8,
                    // -- Lặp và lấy giá trị từ productAttributes
